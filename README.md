...
<!-- MAIN HEADING -->
  ...
  <h3><b>Leaderboard API Project</b></h3>
...
> This is a leaderboard project built with Webpack that consumes an  API 
...
> - [Live Link](https://leaderboard-project-m1q8.onrender.com)
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
```sh
  cd my-folder
  git https://github.com/Armynerh/leaderboard-project
```
<!-- INSTALL -->
